                ...
                <div class="card-body p-2">
                    <form id="save-library" action="{{ route('admin.olympiad.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('url') }}" placeholder="https://" type="url" class="form-control @if($errors->has('url')) is-invalid @endif" id="url" name="url">
                            @if($errors->has('url'))
                                <div class="invalid-feedback">{{ $errors->first('url') }}</div>
                            @endif
                        </div>
                        <div class="form-group">
                            <label for="cover" class="form-lable">Նկար<sup style="color:red;font-weight: bold;">*</sup></label>
