        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body p-2">
                    <form id="save-group" action="{{ route('admin.document.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="name_hy" class="form-lable">Փաստաթղթի անվանումը հայերենով</label>
                            <input type="text" id="name_hy" class="form-control @if($errors->has('name_hy'))in-valid @endif" placeholder="Փաստաթղթի անվանումը հայերենով" name="name_hy" value="{{ old('name_hy') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name_en" class="form-control @if($errors->has('name_en'))in-valid @endif" placeholder="Փաստաթղթի անվանումը անգլերենով" name="name_en" value="{{ old('name_en') }}">
